...
class AddressList extends Component {
    ...
    // 添加地址
    AddressAdd(e){
        window.location.hash = '#/ModifyAddress/'+this.props.params.transfertype
    }
    // 选择地址
    SelectAddress(e,id){
    ...
    Edit(e,id){
        switch(this.props.params.transfertype){
            case 'buy':
                window.location.hash = '#/ModifyAddress/buy/'+id
                break;
            case 'setting':
                window.location.hash = '#/ModifyAddress/setting/'+id
                break;
            case 'shopcart':
                window.location.hash = '#/ModifyAddress/shopcart/'+id
            default:
                break;
        }
