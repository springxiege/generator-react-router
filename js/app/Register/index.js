...
export default class Register extends Component{
    ...
    // 获取验证码
    handleGetVerify(e){
        _hmt.push(['_trackEvent', 'GetVerify', 'click', '获取验证码']);
        let _this = this;
    ...
    // 登录
    Signin(e){
        _hmt.push(['_trackEvent', 'Signin', 'click', '登录']);
        let $form = $(findDOMNode(this.refs.quicForm))
        let mobile = this.state.tel
    ...
    gotoProtocol(){
        _hmt.push(['_trackEvent', 'Protocol', 'click', '我要联赢服务协议']);
    }
    render(){
        return (
            <div className="main">
                <form className="quick-form" ref="quicForm">
                    ...
                    <p className="form-notes">点击登录，即表示您已同意 <Link to={`/Protocol`} onClick={e=>this.gotoProtocol(e)}>《我要联赢服务协议》</Link></p>
