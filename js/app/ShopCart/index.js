...
class ShoppingCart extends React.Component {
                        ...
                        <div className="cart-info">
                            ...
                            <div className="cart-info-item clearfix">
                                ...
                                <div>
                                    ...
                                    <p>&yen;{`${item.goods_addon ? parseFloat(item.goods_addon[config.price]).toFixed(2) : 0.00}`}<span>快递：{`${parseFloat(item.goods?item.goods.fare:0).toFixed(2)}`}元</span></p>
    ...
    handleBilling(e){
        _hmt.push(['_trackEvent', 'Billing', 'click', '去结算']);
        ...
        $.each(_Array,function(index,item) {
            ...
            if(_state.amount[item.id].checked){
                ...
                _Obj.price         = item.goods_addon[config.price];
